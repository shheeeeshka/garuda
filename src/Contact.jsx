...
const Contact = () => {
    return (
        <section className={styles.contact}>
            <h2 className={styles.contactTitle}>Открыты к сотрудничеству и деловым предложениям</h2>
            <div className={styles.contactContent}>
                ...
                <img src="https://cdn.builder.io/api/v1/image/assets/ed385e0488d74a178f255ec248d0cd4a/690bc4d3fbf13fa60069e8b03d3f3aa5b6c7483f5af830375e56ae034b6c7572?apiKey=ed385e0488d74a178f255ec248d0cd4a&" alt="Contact illustration" className={styles.contactIllustration} />
            </div>
        </section>
    );
};
