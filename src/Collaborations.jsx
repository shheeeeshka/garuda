...
const collaborationsData = [
    {
        ...
        description: "Анализируем тренды, разрабатываем стратегии, оказываем поддержку на всех этапах. Реализуем комплекс мер по успешной реализации ВЭД, взаимодействуя с надежными поставщиками, обеспечивая качество и минимизацию рисков."
    },
    {
        ...
        title: "Бизнес-миссии",
        description: "Компания предлагает организацию бизнес-миссий для своих партнеров. Предоставляем консалтинговую и MICE поддержку, включая планирование встреч, подбор местных компаний и решение логистических вопросов"
    },
    {
        ...
        description: "Управление проектами в области ИКТ и смежных отраслей, продвижение продукта на зарубежных рынках, взаимодействуем с ключевыми партнерами в высокотехнологичной, промышленной и обрабатывающей промышленности, предлагая комплексные решения и стратегии для реализации деловых интересов Заказчика."
    }
];
        ...
        <section className={styles.collaborations}>
            ...
            <div className={styles.collaborationsContent}>
                <div style={{ display: 'flex', flexDirection: 'column', width: '40%' }}>
                    <h2 className={styles.collaborationsTitle}>НАПРАВЛЕНИЯ<br />СОТРУДНИЧЕСТВА</h2>
                    <p className={styles.collaborationsSubtitle}>
                        Стратегические направления и задачи, реализуемые консалтинговой группой «Гаруда Солюшн»
                    </p>
                <img src="https://cdn.builder.io/api/v1/image/assets/ed385e0488d74a178f255ec248d0cd4a/ede732181611033d3b55fc5bf2b1b89d6c03b4250373c9df922b4ee265586aad?apiKey=ed385e0488d74a178f255ec248d0cd4a&" alt="Collaborations illustration" className={styles.collaborationsIllustration} />
                </div>
                <div className={styles.collaborationsList}>
                    {collaborationsData.map((collaboration, index) => (
                        <div key={index} className={styles.collaborationItem}>
                            <img src={collaboration.icon} alt={collaboration.title} className={styles.collaborationIcon} />
